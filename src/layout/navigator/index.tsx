...
export default function Navigator() {
  const {collapsed, setCollapsed, md} = useTriggerSlider();
  return (
    <Layout style={{position: 'sticky', top: 0, zIndex: 1}}>
      ...
      >
        <Header collapsed={collapsed} setCollapsed={setCollapsed} md={md} />
      </Layout.Header>
      <Layout style={{ position: 'relative', top: 0, left: 0, bottom: 0, height: 0 }}>
        <Sider collapsed={collapsed} setCollapsed={setCollapsed} md={md} />
      </Layout>
    </Layout>
  );
}
